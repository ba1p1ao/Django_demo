...
class Book(models.Model):
    ...
    author = models.ForeignKey(Author, on_delete=models.CASCADE, related_name='books', verbose_name="作者")  # 关联作者（级联删除）
    publisher = models.ForeignKey(Publisher, on_delete=models.CASCADE, related_name='books', verbose_name="出版社")  # 关联出版社（级联删除）
...
class Review(models.Model):
    ...
    book = models.ForeignKey(Book, on_delete=models.CASCADE, related_name='reviews', verbose_name="关联书籍")  # 关联书籍（级联删除）
...
class BookStore(models.Model):
    ...
    books = models.ManyToManyField(Book, through='Inventory', related_name='bookstores', verbose_name="关联书籍")  # 多对多关联书籍，通过Inventory中间表
